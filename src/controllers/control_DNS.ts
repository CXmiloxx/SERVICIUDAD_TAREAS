...
//   const IP_PRINCIPAL = "20.20.20.20";
//   const IP_SECUNDARIA = "10.10.10.10";

//   const DOMINIOS = ["otro.autolin.com.co"];
//   const HEADERS = {
...
// const verificarConexionHttp = async (ip: string): Promise<string> => {
...
//       return ip;  // Si la respuesta es 200, la IP está activa y la devolvemos
//     }
//   } catch (error) {
...
// // Si la IP actual falla, se cambia por la otra
// const ipDisponible = ip === IP_PRINCIPAL
//   ? await verificarConexionHttp(IP_PRINCIPAL)
//     ? IP_PRINCIPAL
//     : IP_SECUNDARIA
//   : await verificarConexionHttp(IP_SECUNDARIA)
//     ? IP_SECUNDARIA
//     : IP_PRINCIPAL;

// console.log(`Usando IP: ${ipDisponible}`);
...
//   // Si la IP actual falla, se cambia por la otra
//   if (ip === IP_PRINCIPAL) {
//     console.log("Usando IP secundaria...", IP_SECUNDARIA);
//     return IP_SECUNDARIA;
//   } else {
//     console.log("Usando IP principal...", IP_PRINCIPAL);
//     return IP_PRINCIPAL;
//   }
